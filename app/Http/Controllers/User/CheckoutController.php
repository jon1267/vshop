...
class CheckoutController extends Controller
{
    public function store(Request $request)
    {
        ...
        // array of products lines (with currency, product name, price, quantity) as it need for stripe
        $lineItems = [];
        ...
        if ($mainAddress) {
            ...
            // if main address (isMain = 1) exists? set it as customer_address_id
            ...
            foreach ($cartItems as $cartItem) {
                OrderItem::create([
                    'order_id' => $order->id, // Assuming you have id
                    'product_id' => $cartItem->product_id,
                    'quantity' => $cartItem->quantity,
                    'unit_price' => $cartItem->product->price, // You may adjust this on your logic
                ]);
                $cartItem->delete();
